        ...
        <main className="flex-1 p-6 space-y-6 page-enter overflow-auto">
          ...
          <div className="border border-white/[0.12] bg-white/[0.04] p-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-mono text-gray-400 uppercase">NET_AGGREGATE_VALUATION</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="border border-white/[0.12] bg-white/[0.04] p-5">
              <div className="flex items-center justify-between mb-3">
                <span className="text-[10px] font-mono text-gray-500 uppercase">Principal</span>
            ...
            <div className="border border-white/[0.12] bg-white/[0.04] p-5">
              <div className="flex items-center justify-between mb-3">
                <span className="text-[10px] font-mono text-gray-500 uppercase">Yield_Gen</span>
            ...
            <div className="border border-white/[0.12] bg-white/[0.04] p-5">
              <div className="flex items-center justify-between mb-3">
                <span className="text-[10px] font-mono text-gray-500 uppercase">Risk_Level</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="border border-white/[0.12] bg-white/[0.04] p-5">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <div className="text-[10px] font-mono text-gray-500 uppercase mb-1">APY_FLUX_PROTOCOL</div>
                ...
                <div className="text-[10px] font-mono text-gray-500 uppercase">7D_DELTA</div>
              </div>

              {/* Simulated chart area */}
              <div className="h-32 relative chart-glow border-b border-white/[0.1]">
                ...
                <div className="absolute bottom-2 left-0 right-0 flex justify-between text-[9px] font-mono text-gray-500 px-2">
                  <span>MON</span>
                  <span>WED</span>
                  <span>FRI</span>
                  <span>SUN</span>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link href="/stake">
                <button className="w-full h-full min-h-[100px] border border-white/[0.12] bg-white/[0.04] hover:bg-white/[0.07] hover:border-neon-green/30 transition-all flex flex-col items-center justify-center gap-3 p-4 group">
                  <Upload className="w-6 h-6 text-gray-400 group-hover:text-neon-green transition-colors" />
                  <span className="text-xs font-mono font-bold text-white uppercase">Stake</span>
                </button>
              </Link>
              <Link href="/stake?mode=withdraw">
                <button className="w-full h-full min-h-[100px] border border-white/[0.12] bg-white/[0.04] hover:bg-white/[0.07] hover:border-white/25 transition-all flex flex-col items-center justify-center gap-3 p-4 group">
              ...
              <Link href="/games/mines">
                <button className="w-full h-full min-h-[100px] border border-white/[0.12] bg-white/[0.04] hover:bg-white/[0.07] hover:border-neon-green/30 transition-all flex flex-col items-center justify-center gap-3 p-4 group">
                  <Shovel className="w-6 h-6 text-gray-400 group-hover:text-neon-green transition-colors" />
                  <span className="text-xs font-mono font-bold text-white uppercase">Mines</span>
                </button>
              </Link>
              <Link href="/games/plinko">
                <button className="w-full h-full min-h-[100px] border border-white/[0.12] bg-white/[0.04] hover:bg-white/[0.07] hover:border-neon-green/30 transition-all flex flex-col items-center justify-center gap-3 p-4 group">
                  <Grid3X3 className="w-6 h-6 text-gray-400 group-hover:text-neon-green transition-colors" />
          ...
          <div className="border border-white/[0.12] bg-white/[0.04] p-5">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <span className="status-dot online" />
                <span className="text-[10px] font-mono text-gray-400 uppercase">Live_Sequence_Stream</span>
              </div>
              <span className="text-[10px] font-mono text-gray-500">ID_0029461</span>
            </div>

            <div className="space-y-0">
              {MOCK_FEED.map((item, i) => (
                <div key={i} className="flex items-center justify-between py-2.5 border-t border-white/[0.08] first:border-t-0">
